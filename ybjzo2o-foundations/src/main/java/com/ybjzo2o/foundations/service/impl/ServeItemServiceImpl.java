...
import com.ybjzo2o.api.foundations.dto.response.ServeItemResDTO;
import com.ybjzo2o.api.foundations.dto.response.ServeItemSimpleResDTO;
import com.ybjzo2o.api.foundations.dto.response.ServeTypeCategoryResDTO;
import com.ybjzo2o.common.expcetions.ForbiddenOperationException;
import com.ybjzo2o.common.model.PageResult;
import com.ybjzo2o.foundations.constants.RedisConstants;
import com.ybjzo2o.foundations.enums.FoundationStatusEnum;
import com.ybjzo2o.foundations.mapper.ServeItemMapper;
import com.ybjzo2o.foundations.mapper.ServeTypeMapper;
import com.ybjzo2o.foundations.model.domain.ServeItem;
import com.ybjzo2o.foundations.model.domain.ServeType;
import com.ybjzo2o.foundations.model.dto.request.ServeItemPageQueryReqDTO;
import com.ybjzo2o.foundations.model.dto.request.ServeItemUpsertReqDTO;
import com.ybjzo2o.foundations.model.dto.request.ServeSyncUpdateReqDTO;
import com.ybjzo2o.foundations.service.IServeItemService;
import com.ybjzo2o.foundations.service.IServeService;
import com.ybjzo2o.foundations.service.IServeSyncService;
...
public class ServeItemServiceImpl extends ServiceImpl<ServeItemMapper, ServeItem> implements IServeItemService {
    ...
    public void deactivate(Long id) {
        ...
        if (!(count > 0)) {
            throw new ForbiddenOperationException("有区域下在使用上架的服务无法禁用");
        }
        //更新禁用状态
