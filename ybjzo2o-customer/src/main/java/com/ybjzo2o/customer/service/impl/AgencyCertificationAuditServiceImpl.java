...
import com.ybjzo2o.common.enums.EnableStatusEnum;
...
import com.ybjzo2o.customer.mapper.AgencyCertificationAuditMapper;
...
import com.ybjzo2o.customer.service.IAgencyCertificationAuditService;
import com.ybjzo2o.customer.service.IAgencyCertificationService;
...
public class AgencyCertificationAuditServiceImpl extends ServiceImpl<AgencyCertificationAuditMapper, AgencyCertificationAudit> implements IAgencyCertificationAuditService  {
    ...
    public RejectReasonResDTO queryCurrentUserLastRejectReason() {
        LambdaQueryWrapper<AgencyCertificationAudit> queryWrapper = Wrappers.
                <AgencyCertificationAudit>lambdaQuery()
    ...
    public PageResult<AgencyCertificationAuditResDTO> pageQuery(AgencyCertificationAuditPageQueryReqDTO agencyCertificationAuditPageQueryReqDTO) {
        ...
        Page<AgencyCertificationAudit> serveTypePage = baseMapper.selectPage(page, queryWrapper);
        return PageUtils.toPage(serveTypePage, AgencyCertificationAuditResDTO.class);
    }
    /**
     * 审核认证信息
     *
    ...
    public void auditCertification(Long id, CertificationAuditReqDTO certificationAuditReqDTO) {
        ...
        if (ObjectUtil.equal(CertificationStatusEnum.SUCCESS.getStatus(), certificationAuditReqDTO.getCertificationStatus())) {
            ...
            agencyCertificationUpdateDTO.setCertificationTime(agencyCertificationAudit.getAuditTime().toLocalDateTime());
        }
